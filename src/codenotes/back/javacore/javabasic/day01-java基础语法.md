...
::: left
&nbsp;![](../img/15557854820208960.png  =800x280)
:::
...
cmd默认操作C盘下的users文件夹下的XXX文件夹。（XXX就是计算机名）
 ...
 ![](https://gitee.com/private_crh/notes/raw/master/typora/cmd.png)
...
<span style="color: red;">在windows操作系统当中，文件名或者文件夹名是忽略大小写的。</span>
...
![](https://gitee.com/private_crh/notes/raw/master/typora/1.png)

第二步：点击高级系统设置。

​	 ![](https://gitee.com/private_crh/notes/raw/master/typora/2.png)

第三步：选择高级，再点击下面的环境变量。

 ![](https://gitee.com/private_crh/notes/raw/master/typora/3.png)



第四步：找系统变量里面的PATH

 ![](https://gitee.com/private_crh/notes/raw/master/typora/4.png)
...
移动的好处：在CMD中打开软件时，会先找当前路径，再找环境变量，在环境变量中是从上往下依次查找的，如果路径放在最上面查找的速度比较快。
 ...
 ![](https://gitee.com/private_crh/notes/raw/master/typora/5.png)
...
![](https://gitee.com/private_crh/notes/raw/master/typora/image-20210923091654365.png)
...
![](https://gitee.com/private_crh/notes/raw/master/typora/image-20210923091710450.png)

②**Path**：告诉操作系统JDK提供的javac(编译)、java(执行)命令安装到了哪个位置

![](https://gitee.com/private_crh/notes/raw/master/typora/image-20210923091721035.png)
...
![](https://gitee.com/private_crh/notes/raw/master/typora/image-20210923091350952.png)

### 2.9 JRE和JDK

![](https://gitee.com/private_crh/notes/raw/master/typora/image-20210923091544110.png)
